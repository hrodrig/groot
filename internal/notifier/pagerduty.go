...
func sendPagerDutyV2(ctx context.Context, httpN *httpNotify, route pagerDutyRoute, summaryLine string, sum collector.Summary) error {
	...
	if err := httpN.postJSONWithRetry(ctx, pagerDutyEventsURL, body, nil); err != nil {
