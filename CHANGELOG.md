...
- **README / man pages / BSD ports:** version badge, image pin, and packaging synced to **1.1.2**. Go version badge synced to **1.26.6**.
- **Grype:** directory scan also excludes local `./.tmp-go/**` so leftover test binaries do not fail `make security`.
