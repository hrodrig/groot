...
**SPECIFICATIONS** is the testable contract; **[README.md](../README.md)** is the operator guide with usage examples; **[configs/groot.yml.sample](../configs/groot.yml.sample)** is the annotated sample config; **[deploy/](../deploy/)** documents in-cluster Helm and CronJob manifests.
...
| Helm / CronJob | [deploy/README.md](../deploy/README.md), [deploy/helm/groot/README.md](../deploy/helm/groot/README.md) |
